...
$this->title = 'Jenis Pembayaran ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Jenis Pembayaran', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => (string)$model->id, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'View';
?>
<div class="giiant-crud jenis-pembayaran-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . 'Daftar Jenis Pembayaran', ['index'], ['class'=>'btn btn-default']) ?>
    </p>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            ...
            ['pembayaran/create', 'Pembayaran' => ['jenis_pembayaran_id' => $model->id]],
...
<?= '<div class="table-responsive">'
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params['Pembayaran'] = ['jenis_pembayaran_id' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
...
<?php $this->endBlock() ?>
    ...
    'content' => $this->blocks['app\models\JenisPembayaran'],
    'active'  => true,
],[
