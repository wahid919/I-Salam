        ...
        if (nominal == null || nominal == "0" || nominal == 0) {
          ...
          alert("Pendanaan Tidak Diketahui");
            ...
            if(nominal <10000){
              ...
              window.location.href = `<?= Url::to(['/home/pembayaran-header', 'id' => $pendanaan->id]) ?>?nominal=${nominal}&amanah_pendanaan=${amanah_pendanaan}&nama=${nama}&email=${email}&phone=${phone}&ket=nominal-sedekah`;
            }
          }
        }
      });
      document.querySelector("#bayarkan2_header").addEventListener("click", () => {
        ...
        if (nominal2 == null) {
          ...
          alert("Pendanaan Tidak Diketahui");
            ...
            window.location.href = `<?= Url::to(['/home/pembayaran-header', 'id' => $pendanaan->id]) ?>?nominal=${nominal2}&amanah_pendanaan=${amanah_pendanaan2}&nama=${nama2}&email=${email2}&phone=${phone2}ket=lembar-sedekah`;
          }
        }
      });
