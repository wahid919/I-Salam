            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-12">
                    ...
                    <?php }else{ ?>
                      <button type="submit" class="btn-sm btn-block text-white font-weight-bold" style="height: 3rem;background-color: #f1a502;" id="status_pembayaran">Mulai Infak</button>
                      <script>
                    ...
                    <?php } ?>
                    <?php } else { ?>
                      <button type="button" class="btn-sm btn-block text-white font-weight-bold" style="height: 3rem;background-color: #f1a502;" id="btn-user-login">Mulai Infak</button>
                    <?php
                    } ?>
                    <br>
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 mt-2">
                        <div class="input-group mb-2">
                          ...
                          <input type="number" class="form-control select-wakaf" id="nominal" name="nominal" style="border-color: #787878;" placeholder="Minimal Infak Rp. 10.000" required>
