...
// $setting = app\models\Pe::find()->one();
                    ...
                    <table class="table table-hover">
                      <thead>
                        <?php foreach ($donatur as $done) {
                          $sub_kalimat = substr($done->nama, 0);
                          $user = app\models\User::find()->one();
                          $photo = \Yii::$app->request->baseUrl . "/uploads/user_image" . $user->photo_url;
                          // $sub_kalimat = substr($done->nama, 0, 3);
                          $nm = $sub_kalimat . ""; ?>
                          <tr>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 pt-70">
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-4">
                  <img style="width: 50px;" src="<?= $icons ?>">
                </div>
                <div class="col-8">
...
<div class="modal fade" id="mulaiwakafheader" tabindex="-1" role="dialog" aria-labelledby="mulaiwakafheader" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="mulaiwakafheader">Pembayaran Wakaf</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="pembayarans" role="tabpanel" aria-labelledby="pembayarans-tab">
            <div class="row">
              ...
              <div class="col-12 pt-3">
                <h5 style="color: #404040;">Nominal Wakaf</h5>
                <p class="font-size-08">Beban Biaya Setiap Transaksi :</p>
                <table style="width: 100%;">
                  <tbody>
                    <tr>
          ...
          <div class="tab-pane fade" id="lembarans" role="tabpanel" aria-labelledby="lembarans-tab">
            <div class="row">
              ...
              <div class="col-12 pt-3">
                <h5 style="color: #404040;">Lembar Wakaf</h5>
                <p class="font-size-08">Beban Biaya Setiap Transaksi :</p>
                <table style="width: 100%;">
                  <tbody>
                    <tr>
                ...
                <div class="row">
                  ...
                  <div class="col-12 mt-2">
                    <div class="input-group mb-2">
                      ...
                      <input type="number" class="form-control select-wakaf" id="nominal2_header" name="nominal2_header" style="border-color: #787878;border-radius:5px;margin-right:1%;" placeholder="Minimal Wakaf 1 Lembar" required>
