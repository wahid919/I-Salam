            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-12">
                    ...
                    <a href="#" class="btn btn-sm btn-program btn-block" data-toggle="modal" data-target="#mulaiwakaf" style="padding: 10px !important;">Mulai Zakat</a>
                    <?php }else{ ?>
                      <button type="submit" class="btn-sm btn-block text-white font-weight-bold" style="height: 3rem;background-color: #d07400;" id="status_pembayaran">Mulai Zakat</button>
                      <script>
                    ...
                    <?php } ?>
                    <?php } else { ?>
                      <!-- <button type="button" class="btn-sm btn-block text-white font-weight-bold" style="height: 3rem;background-color: #d07400;" id="btn-user-login">Mulai Zakat</button> -->
                      <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                          <a href="#" data-toggle="modal" data-target="#mulaiwakafheader">
                            <button class="btn-sm btn-block text-white font-weight-bold" style="border-radius:7px;height: 3rem;background-color: #d07400;">Mulai Zakat</button>
                          </a>
                        </div>
                      </div>
                    <?php
...
<div class="modal fade" id="mulaiwakafheader" tabindex="-1" role="dialog" aria-labelledby="mulaiwakafheader" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="mulaiwakafheader">Pembayaran Zakat</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="pembayarans" role="tabpanel" aria-labelledby="pembayarans-tab">
                <div class="row">
                  ...
                  <div class="col-8">
                    <p class="font-size-08">Anda akan berzakat untuk program :</p>
                    <p class="font-weight-bold">
                      <?= $pendanaan->nama_pendanaan ?>
                    </p>
                  </div>
                  <div class="col-12 pt-3">
                    <h5 style="color: #404040;">Nominal Zakat</h5>
                    <p class="font-size-08">Beban Biaya Setiap Transaksi :</p>
                    <table style="width: 100%;">
                      <tbody>
                      <tr>
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 mt-2">
                        <div class="input-group mb-2">
                          ...
                          <input type="number" class="form-control select-wakaf" id="nominal_header" name="nominal_header" onkeyup="myFunction_header()" onkeydown="myFunction_header()" style="border-color: #787878;border-radius:5px;margin-right:1%;" placeholder="Minimal Zakat Rp. 10.000" required>
            ...
            hasils_header.value = "";
              ...
              <div class="tab-pane fade" id="lembarans" role="tabpanel" aria-labelledby="lembarans-tab">
                <div class="row">
                  ...
                  <div class="col-12 pt-3">
                    <h5 style="color: #404040;">Lembar Zakat</h5>
                    <p class="font-size-08">Beban Biaya Setiap Transaksi :</p>
                    <table style="width: 100%;">
                      <tbody>
                      <tr>
                    ...
                    <div class="col-6">
                      ...
                      <div class="col-12 mt-2">
                        <div class="input-group mb-2">
                          ...
                          <input type="number" class="form-control select-wakaf" id="nominal2_header" name="nominal2_header" style="border-color: #787878;border-radius:5px;margin-right:1%;" placeholder="Minimal Zakat 1 Lembar" required>
