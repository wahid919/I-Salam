    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-12 text-category">
        ...
        <select class="form-control select-category ml-auto" id="select-category">
          <option class="font-weight-bold" value="<?= \Yii::$app->request->baseUrl . "/home/program-infak/" ?>">Semua Kategori</option>
          <?php

          use yii\helpers\Url;

          foreach ($kategori_pendanaans as $kategori_pendanaan) {  ?>
            <option class="font-weight-bold" value="<?= \Yii::$app->request->baseUrl . "/home/program-infak?kategori=" . $kategori_pendanaan->name ?>"><?= $kategori_pendanaan->name ?></option>
          <?php } ?>
        </select>
      </div>
    </div>
          ...
          <div class="card shadow-br2" style="border-radius: 15px;">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <i class="fa fa-users" aria-hidden="true"></i> Jumlah Yang Infak(<?= $pewakaf ?>)
                </div>
                </div>
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12" style="margin-top: 5px;">
                  <a href="<?= Url::to(["detail-program-infak", "id" => $pendanaan->id]) ?>" class="btn btn-sm btn-program btn-block">Mulai Infak</a>
                </div>
              </div>
            </div>
          </div>
