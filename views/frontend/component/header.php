      ...
      <nav class="navbar navbar-expand-lg sticky-navbar">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            ...
            <li class="nav__item">
                <a href="<?=Yii::$app->request->baseUrl . "/frontend/index" ?>" class="nav__item-link active">HOME</a>
              </li><!-- /.nav-item -->
              <li class="nav__item">
                <a href="<?=Yii::$app->request->baseUrl . "/frontend/program/" ?>" class="nav__item-link">PROGRAM</a>
              </li><!-- /.nav-item -->
              <li class="nav__item">
                <a href="<?=Yii::$app->request->baseUrl . "/frontend/berita/" ?>" class="nav__item-link">NEWS</a>
              </li><!-- /.nav-item -->
              <li class="nav__item">
